...
import { CreateEditorsComponent } from '../editors-table/create-editors/create-editors.component';
import { CreateDevelopersComponent } from '../developers-table/create-developers/create-developers.component';
import { CreateFranchiseComponent } from '../franchises-table/create-franchise/create-franchise.component';
